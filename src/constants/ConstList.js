...
export const searchShort = ["slot1short", "slot2short", "slot3short", "slot4short"]

export const listStatus = ["艦隊編成", "ステータス", "出撃海域"]
export const listStatusS = ["group", "status", "map"]

export const listAircraft = ["fighter", "bomber", "torpedo", "jetFB", "scout", "scout2", "seaplane", "seaplaneX", "heli", "blue", "big"]
export const listAircraftName = ["艦上戦闘機", "艦上爆撃機", "艦上攻撃機", "噴式戦闘爆撃機", "艦上偵察機", "水上偵察機", "水上爆撃機", "水上戦闘機", "オートジャイロ", "対潜哨戒機", "大型飛行艇"]
export const listAircraftS = ["sit6", "sit7", "sit8", "sit39", "sit9", "sit10", "sit10", "sit10", "sit21", "sit22", "sit33"]
export const listAircraftColor = ["green-800", "red-800", "blue-800", "yellow-900", "yellow-800", "green-600", "green-600", "green-600", "green-700", "blue-500", "green-600"]
